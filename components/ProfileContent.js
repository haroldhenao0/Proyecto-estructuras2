      ...
      {activeTab === 'about' && (
        <div>
          <Card>
            ...
            <p className="mb-2 text-sm">Mi nombre es Juan Sebastian Losada Sanchez, tengo 19 años y estudio en la Universidad Autónoma de Occidente</p>
            <p className="mb-2 text-sm">La carrera que estudio se llama Ingenieria Informatica</p>
          </Card>
        </div>
      )}
      {activeTab === 'friends' && (
